...
{
    private readonly Expression _functionExpr;
    private readonly List<Expression> _argumentExprs;
...
{
    private readonly Expression conditionExpr;
    private readonly Expression thenExpr;
    private readonly Expression elseExpr;
...
public class NameExpression : Expression
{
    ...
    public void Print(StringBuilder sb) => sb.Append(Name);
}
