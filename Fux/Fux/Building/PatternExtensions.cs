...
{
    public static IEnumerable<A.Decl.Parameter> ExtractNamedParameters(this A.Pattern pattern, Module module) => pattern.Flatten().Select(id => new A.Decl.Parameter(module, id));

    public static IEnumerable<A.Decl.Parameter> ExtractMatchNames(this A.Pattern pattern, Module module) => Flatten(pattern, null, true).Select(name => new A.Decl.Parameter(module, name));

    public static IEnumerable<A.Pattern.LowerId> ExractMatchIds(this A.Pattern pattern) => Flatten(pattern, null, true);
