namespace Fux.Building
{
    ...
    {
        public static IEnumerable<A.Decl.Parameter> ExtractNamedParameters(this A.Pattern pattern, Module module)
        {
            return pattern.Flatten().Select(id => new A.Decl.Parameter(module, id));
        }

        public static IEnumerable<A.Decl.Parameter> ExtractMatchNames(this A.Pattern pattern, Module module)
        {
            return Flatten(pattern, null, true).Select(name => new A.Decl.Parameter(module, name));
        }
