...
public sealed class Phase6Resolve : Phase
{
    ...
    private class Maker : Phase
    {
        ...
        public override void Make()
        {
            ...
            {
                Investigated = Module.Name == "List" && declaration is A.Decl.Var var && var.Name.Text == "repeat2";
                Resolve(declaration);
            }
        }
        ...
        private void Resolve(A.Decl declaration)
        {
            ...
            switch (declaration)
            {
                ...
                case A.Decl.TypeAnnotation annotation:
                    {
                        annotation.Type = ResolveType(Module.Scope, annotation.Type);
                        break;
                    }
                ...
                case A.Decl.Alias alias:
                    {
                        ...
                        alias.Declaration = ResolveType(Module.Scope, alias.Declaration);
                ...
                case A.Decl.Ctor ctor:
                    {
                        ...
                        {
                            ctor.Arguments[i] = ResolveType(Module.Scope, ctor.Arguments[i]);
                        }
                        break;
                    }

                case A.Decl.TypeClass:

                    {
                        break;
                    }

                case A.Decl.ClassInstance:
                ...
                case A.Type.Custom customType:
                    {
                        ...
                        Assert(resolved is A.Decl.Custom or A.Decl.Alias);
