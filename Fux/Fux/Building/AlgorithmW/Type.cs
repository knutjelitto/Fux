...
public abstract class Type
{
    ...
    {
        public Variable(TypeVariable typeVar) => TypeVar = typeVar;

        public TypeVariable TypeVar { get; }

        public void Deconstruct(out TypeVariable typeVar) => typeVar = TypeVar;
    ...
    {
        protected Tuple(params Type[] types) => Types = types;
    ...
    {
        public List(Type type) => Type = type;

        public Type Type { get; }

        public Type At(int index) => index == 0 ? Type : this;
    ...
    public sealed class Custom : Type
    {
        ...
        private string StrArguments => Arguments != null && Arguments.Count > 0 ? $"<{string.Join(", ", Arguments)}>" : "";
    ...
    {
        public Record(IReadOnlyList<Field> fields) => Fields = fields;
        ...
        public void Deconstruct(out IReadOnlyList<Field> fields) => fields = Fields;
    }

    public abstract class Primitive : Type
    {
        protected Primitive(string name) => Name = name;
