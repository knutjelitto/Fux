...
public sealed class Environment
{
    ...
    public static Environment From(Environment env, IEnumerable<(TermVariable var, Polytype poly)> values) => new(env.Generator, values);
    ...
    public static Environment Empty() => Initial(new TypeVarGenerator());

    public Environment NewEmpty() => Initial(Generator);
