...
public static class WriterExtensions
{
    ...
    public static Writer Writer(this string filename, int? indent = null) => new(File(filename), indent);
    ...
    public static void WriteLine(this Writer writer, object obj) => writer.WriteLine(obj.ToString() ?? throw new ArgumentNullException(nameof(obj)));
}
