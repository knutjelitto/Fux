namespace Fux.Parsing
{
    public class Lex
    {
        ...
        public static readonly Lex Identifier = Add(new("identifier", LexClass.Identifier));
        public static readonly Lex OpIdentifier = Add(new("op-identifier", LexClass.Identifier));
        public static readonly Lex WasmIdentifier = Add(new("wasm-identifier", LexClass.Identifier));

        public static readonly Lex Integer = Add(new("integer", LexClass.Literal));
        public static readonly Lex Float = Add(new("float", LexClass.Literal));
        public static readonly Lex String = Add(new("string", LexClass.Literal));
        public static readonly Lex LongString = Add(new("long-string", LexClass.Literal));
        public static readonly Lex Char = Add(new("char", LexClass.Literal));

        public static readonly Lex Wildcard = Add(new("wildcard", LexClass.Other));
        ...
        public static readonly Lex OpNot = Add(new("!", LexClass.Prefix));
        public static readonly Lex OpBitNot = Add(new("~", LexClass.Prefix));
        ...
        public static readonly Lex OpSub = Add(new("-", LexClass.Infix|LexClass.Prefix));
        ...
        public static readonly Lex LeftRoundBracket = Add(new("(", LexClass.Bracket));
        ...
        public static readonly Lex KwIf = Add(new("if", LexClass.Keyword));
        ...
        public static readonly Lex KwWhen = Add(new("when", LexClass.Keyword));

        public static readonly Lex KwCase = Add(new("case", LexClass.Keyword));
        public static readonly Lex KwOf = Add(new("of", LexClass.Keyword));

        public static readonly Lex KwLoop = Add(new("loop", LexClass.Keyword));
        public static readonly Lex KwBreak = Add(new("break", LexClass.Keyword));
        public static readonly Lex KwContinue = Add(new("continue", LexClass.Keyword));

        public static readonly Lex KwVal = Add(new("val", LexClass.Keyword));
        public static readonly Lex KwVar = Add(new("var", LexClass.Keyword));
        public static readonly Lex KwWasm = Add(new("wasm", LexClass.Keyword));
