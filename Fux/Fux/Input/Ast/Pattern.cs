...
public interface Pattern : Node
{
    ...
    public class LowerId : PatternImpl
    {
        ...
        {
            Assert(identifier.IsSingleLowerOrOp);
        ...
        public void Deconstruct(out Identifier identifier) => identifier = Identifier;
    ...
    public class Signature : PatternImpl
    {
        ...
        public override string ToString() => Parameters.Count == 0 ? $"{Name}" : $"({Name} {string.Join(" ", Parameters)})";
    }

    public class Lambda : PatternImpl
    {
        public Lambda(List<Pattern> parameters) => Parameters = parameters;
    ...
    public class Record : PatternImpl
    {
        ...
        public Record(params Pattern[] patterns) => Patterns = patterns;
    ...
    {
        protected Tuple(params Pattern[] patterns) => Patterns = patterns.ToList();
    ...
    {
        public List(List<Pattern> patterns) => Patterns = patterns;
    ...
    {
        public Literal(Expr.Literal lit) => Lit = lit;
        ...
        {
            public Integer(Expr.Literal.Integer literal) : base(literal) => Value = literal.Value;
