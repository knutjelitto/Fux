...
namespace Fux.Input.Ast
{
    public sealed class Identifier : ListOf<Token>, IEquatable<Identifier>
    {
        ...
        public static Identifier Artificial(Source source, string artifical)
        {
            return Artificial(new Location(source, 0, 0), artifical);
        }

        public static Identifier Artificial(ILocation location, string artifical)
        {
